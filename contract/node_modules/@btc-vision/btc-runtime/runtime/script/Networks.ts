...
export class NetworkManager {
    ...
    constructor() {
        ...
        // OP_NET testnet genesis block hash (0000017f85106b1feeaf2f70f1e2b805985bb575f88f9b0ba5753d2f3cf13273)
    ...
    public fromChainId(chainId: Uint8Array): Networks {
        ...
        if (this.equals(chainId, this.opnetTestnet)) return Networks.Testnet;
